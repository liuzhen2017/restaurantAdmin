...
create table sys_dept (
  ...
  dept_name 		varchar(30) 	default '' 				   comment '部门名稱',
...
(
	...
	post_name     varchar(50)     not null                   comment '岗位名稱',
...
create table sys_menu (
  ...
  menu_name 		varchar(50) 	not null 				   comment '菜单名稱',
...
create table sys_oper_log (
  ...
  dept_name 		varchar(50)     default '' 		 	 	   comment '部门名稱',
...
create table sys_config (
	...
	config_name        varchar(100)  default ''                 comment '参数名稱',
...
insert into sys_config values(1, '主框架页-默认皮肤样式名稱', 'sys.index.skinName',     'skin-blue',     'Y', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow' );
...
create table sys_job (
  ...
  job_name            varchar(64)   default ''                 comment '任务名稱',
...
create table sys_job_log (
  ...
  job_name            varchar(64)   not null                   comment '任务名稱',
